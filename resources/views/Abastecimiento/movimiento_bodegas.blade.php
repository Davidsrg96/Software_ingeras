...
@section('cuerpo')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form role="form" method="POST" action="{{route('despacho.movimiento',[$almacen_origen->id,$almacen_destino->id])}}"  enctype="multipart/form-data">
            ...
            <table class="table table-hover table-striped" id="tabla_bodega" width="100%">
                ...
                @foreach($producto as $p)
                    <tr>
                        ...
                        <td><input type="number" min="0" max="{{$p->Cantidad_almacenada}}" step="1" class="container" id="cant{{$p->id}}"></td>
